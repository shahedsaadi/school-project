...
// Exam/////////////////////////////////////////////////////////////////////
    ...
    // update Homework =thursday=
        if(isset($_POST['saveexam'])){
            ...
            $sql="UPDATE exam_schedule set day='{$day1}', date='{$datee1}', grade1='{$subject1}' WHERE id_exam ='{$ide1}'";
            $stmt = $con->prepare($sql);
            $stmt->execute();
            ...
            $sql="UPDATE exam_schedule set day='{$day2}', date='{$datee2}', grade1='{$subject2}' WHERE id_exam ='{$ide2}'";
            $stmt = $con->prepare($sql);
            $stmt->execute();
            ...
            $sql="UPDATE exam_schedule set day='{$day3}', date='{$datee3}', grade1='{$subject3}' WHERE id_exam ='{$ide3}'";
            $stmt = $con->prepare($sql);
            $stmt->execute();
            ...
            $sql="UPDATE exam_schedule set day='{$day4}', date='{$datee4}', grade1='{$subject4}' WHERE id_exam ='{$ide4}'";
            $stmt = $con->prepare($sql);
            $stmt->execute();
            ...
            $sql="UPDATE exam_schedule set day='{$day5}', date='{$datee5}', grade1='{$subject5}' WHERE id_exam ='{$ide5}'";
            $stmt = $con->prepare($sql);
            $stmt->execute(); 
        }
                        ...
                        <table class="Tables">
                           <tr>
                            ...
                            <tr>
                                ...
                                <td class="ex-sub">
                                    <input type="text" name="es1" id="es1" class="cells" value="<?php echo $rowe1['grade1']; ?>"></td>
                                <td class="ex-dat">
                            ...
                            <tr>
                                ...
                                <td class="ex-sub">
                                    <input type="text" name="es2" id="es2" class="cells" value="<?php echo $rowe2['grade1']; ?>"></td>
                                <td class="ex-dat">
                            ...
                            <tr>
                                ...
                                <td class="ex-sub">
                                    <input type="text" name="es3" id="es3" class="cells" value="<?php echo $rowe3['grade1']; ?>"></td>
                                <td class="ex-dat">
                            ...
                            <tr>
                                ...
                                <td class="ex-sub">
                                    <input type="text" name="es4" id="es4" class="cells" value="<?php echo $rowe4['grade1']; ?>"></td>
                                <td class="ex-dat">
                            ...
                            <tr>
                                ...
                                <td class="ex-sub">
                                    <input type="text" name="es5" id="es5" class="cells" value="<?php echo $rowe5['grade1']; ?>"></td>
                                <td class="ex-dat">
